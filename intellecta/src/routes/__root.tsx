...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Intellecta — Your Local Knowledge Assistant" },
      { name: "description", content: "Intellecta is a privacy-first knowledge assistant powered by local RAG. Chat with your documents, get cited answers." },
      { name: "author", content: "Intellecta" },
      { property: "og:title", content: "Intellecta — Your Local Knowledge Assistant" },
      { property: "og:description", content: "Chat with your documents using local RAG. Cited answers, multi-document upload, conversation history." },
